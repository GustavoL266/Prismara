...
export function installAdvancedLine(w:World,f:Factory){
 ...
 const cooling=f.add('filter',112,152)!;cooling.mode='density';cooling.densityMin=175;cooling.densityMax=260;f.rebuildBlocks();
 for(let y=152;y<158;y++)w.set(111,y,Mat.Wall);
