...
export async function validateExploration(page,screenshot,pass){
  ...
  });assert.deepEqual(restored,{version:5,mask:true,memory:true,variants:true,map:true});pass('Portable v5 snapshot preserves discovery and last observation exactly',restored);
